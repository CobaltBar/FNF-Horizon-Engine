...
class LogFrontEnd
{
	...
	{
		ErrorState.errs.push('WARN: $data');
		@:privateAccess Log.print(data, 'FLIXEL WARN', 214);
		advanced(data, LogStyle.WARNING, true);
	}

	public inline function error(data:Dynamic):Void
	{
		ErrorState.errs.push('ERROR: $data');
		@:privateAccess Log.print(data, 'FLIXEL ERROR', 196);
